...
type CandidateServiceClient interface {
	...
	GetByIdCandidate(ctx context.Context, in *election.ById, opts ...grpc.CallOption) (*GetAllCandidate, error)
}
...
func (c *candidateServiceClient) GetByIdCandidate(ctx context.Context, in *election.ById, opts ...grpc.CallOption) (*GetAllCandidate, error) {
...
type CandidateServiceServer interface {
	...
	GetByIdCandidate(context.Context, *election.ById) (*GetAllCandidate, error)
...
func (UnimplementedCandidateServiceServer) GetByIdCandidate(context.Context, *election.ById) (*GetAllCandidate, error) {
