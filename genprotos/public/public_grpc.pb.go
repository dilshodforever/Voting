...
type PublicServiceClient interface {
	...
	GetByIdPublic(ctx context.Context, in *election.ById, opts ...grpc.CallOption) (*GetAllPublic, error)
}
...
func (c *publicServiceClient) GetByIdPublic(ctx context.Context, in *election.ById, opts ...grpc.CallOption) (*GetAllPublic, error) {
...
type PublicServiceServer interface {
	...
	GetByIdPublic(context.Context, *election.ById) (*GetAllPublic, error)
...
func (UnimplementedPublicServiceServer) GetByIdPublic(context.Context, *election.ById) (*GetAllPublic, error) {
