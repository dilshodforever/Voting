...
type VoteServiceClient interface {
	...
	GetByIdVote(ctx context.Context, in *election.ById, opts ...grpc.CallOption) (*GetAllVote, error)
}
...
func (c *voteServiceClient) GetByIdVote(ctx context.Context, in *election.ById, opts ...grpc.CallOption) (*GetAllVote, error) {
	out := new(GetAllVote)
...
type VoteServiceServer interface {
	...
	GetByIdVote(context.Context, *election.ById) (*GetAllVote, error)
...
func (UnimplementedVoteServiceServer) GetByIdVote(context.Context, *election.ById) (*GetAllVote, error) {
