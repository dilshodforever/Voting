...
type VoteServiceClient interface {
	CreateVote(ctx context.Context, in *Vote, opts ...grpc.CallOption) (*Void, error)
	DeleteVote(ctx context.Context, in *ById, opts ...grpc.CallOption) (*Void, error)
	UpdateVote(ctx context.Context, in *Vote, opts ...grpc.CallOption) (*Void, error)
	GetByIdVote(ctx context.Context, in *ById, opts ...grpc.CallOption) (*Vote, error)
	GetAllVotes(ctx context.Context, in *Void, opts ...grpc.CallOption) (*GetAllVote, error)
}
...
func (c *voteServiceClient) CreateVote(ctx context.Context, in *Vote, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
	err := c.cc.Invoke(ctx, "/protos.VoteService/CreateVote", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *voteServiceClient) DeleteVote(ctx context.Context, in *ById, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
	err := c.cc.Invoke(ctx, "/protos.VoteService/DeleteVote", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *voteServiceClient) UpdateVote(ctx context.Context, in *Vote, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
	err := c.cc.Invoke(ctx, "/protos.VoteService/UpdateVote", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *voteServiceClient) GetByIdVote(ctx context.Context, in *ById, opts ...grpc.CallOption) (*Vote, error) {
	out := new(Vote)
	err := c.cc.Invoke(ctx, "/protos.VoteService/GetByIdVote", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *voteServiceClient) GetAllVotes(ctx context.Context, in *Void, opts ...grpc.CallOption) (*GetAllVote, error) {
	out := new(GetAllVote)
	err := c.cc.Invoke(ctx, "/protos.VoteService/GetAllVotes", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type VoteServiceServer interface {
	CreateVote(context.Context, *Vote) (*Void, error)
	DeleteVote(context.Context, *ById) (*Void, error)
	UpdateVote(context.Context, *Vote) (*Void, error)
	GetByIdVote(context.Context, *ById) (*Vote, error)
	GetAllVotes(context.Context, *Void) (*GetAllVote, error)
...
func (UnimplementedVoteServiceServer) CreateVote(context.Context, *Vote) (*Void, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateVote not implemented")
}
func (UnimplementedVoteServiceServer) DeleteVote(context.Context, *ById) (*Void, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteVote not implemented")
}
func (UnimplementedVoteServiceServer) UpdateVote(context.Context, *Vote) (*Void, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateVote not implemented")
}
func (UnimplementedVoteServiceServer) GetByIdVote(context.Context, *ById) (*Vote, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetByIdVote not implemented")
}
func (UnimplementedVoteServiceServer) GetAllVotes(context.Context, *Void) (*GetAllVote, error) {
...
func _VoteService_CreateVote_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protos.VoteService/CreateVote",
	}
...
func _VoteService_DeleteVote_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protos.VoteService/DeleteVote",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VoteServiceServer).DeleteVote(ctx, req.(*ById))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _VoteService_UpdateVote_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protos.VoteService/UpdateVote",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _VoteService_GetByIdVote_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protos.VoteService/GetByIdVote",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VoteServiceServer).GetByIdVote(ctx, req.(*ById))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _VoteService_GetAllVotes_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protos.VoteService/GetAllVotes",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VoteServiceServer).GetAllVotes(ctx, req.(*Void))
	}
	return interceptor(ctx, in, info, handler)
}
