...
const (
	...
	PartyService_GetByIdParty_FullMethodName = "/protos.PartyService/GetByIdParty"
	PartyService_GetAllPartys_FullMethodName = "/protos.PartyService/GetAllPartys"
)
...
type PartyServiceClient interface {
	CreateParty(ctx context.Context, in *Party, opts ...grpc.CallOption) (*election.Void, error)
	DeleteParty(ctx context.Context, in *election.ById, opts ...grpc.CallOption) (*election.Void, error)
	UpdateParty(ctx context.Context, in *Party, opts ...grpc.CallOption) (*election.Void, error)
	GetByIdParty(ctx context.Context, in *election.ById, opts ...grpc.CallOption) (*Party, error)
	GetAllPartys(ctx context.Context, in *election.Void, opts ...grpc.CallOption) (*GetAllParty, error)
}
...
func (c *partyServiceClient) CreateParty(ctx context.Context, in *Party, opts ...grpc.CallOption) (*election.Void, error) {
...
func (c *partyServiceClient) DeleteParty(ctx context.Context, in *election.ById, opts ...grpc.CallOption) (*election.Void, error) {
	out := new(election.Void)
...
func (c *partyServiceClient) UpdateParty(ctx context.Context, in *Party, opts ...grpc.CallOption) (*election.Void, error) {
	out := new(election.Void)
...
func (c *partyServiceClient) GetByIdParty(ctx context.Context, in *election.ById, opts ...grpc.CallOption) (*Party, error) {
	out := new(Party)
	err := c.cc.Invoke(ctx, PartyService_GetByIdParty_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *partyServiceClient) GetAllPartys(ctx context.Context, in *election.Void, opts ...grpc.CallOption) (*GetAllParty, error) {
	out := new(GetAllParty)
	err := c.cc.Invoke(ctx, PartyService_GetAllPartys_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PartyServiceServer interface {
	CreateParty(context.Context, *Party) (*election.Void, error)
	DeleteParty(context.Context, *election.ById) (*election.Void, error)
	UpdateParty(context.Context, *Party) (*election.Void, error)
	GetByIdParty(context.Context, *election.ById) (*Party, error)
	GetAllPartys(context.Context, *election.Void) (*GetAllParty, error)
...
func (UnimplementedPartyServiceServer) CreateParty(context.Context, *Party) (*election.Void, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateParty not implemented")
}
func (UnimplementedPartyServiceServer) DeleteParty(context.Context, *election.ById) (*election.Void, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteParty not implemented")
}
func (UnimplementedPartyServiceServer) UpdateParty(context.Context, *Party) (*election.Void, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateParty not implemented")
}
func (UnimplementedPartyServiceServer) GetByIdParty(context.Context, *election.ById) (*Party, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetByIdParty not implemented")
}
func (UnimplementedPartyServiceServer) GetAllPartys(context.Context, *election.Void) (*GetAllParty, error) {
...
func _PartyService_DeleteParty_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PartyServiceServer).DeleteParty(ctx, req.(*election.ById))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _PartyService_GetByIdParty_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PartyServiceServer).GetByIdParty(ctx, req.(*election.ById))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _PartyService_GetAllPartys_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PartyServiceServer).GetAllPartys(ctx, req.(*election.Void))
	}
	return interceptor(ctx, in, info, handler)
}
