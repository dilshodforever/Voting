...
type PartyServiceClient interface {
	...
	GetByIdParty(ctx context.Context, in *election.ById, opts ...grpc.CallOption) (*GetAllPartys, error)
}
...
func (c *partyServiceClient) GetByIdParty(ctx context.Context, in *election.ById, opts ...grpc.CallOption) (*GetAllPartys, error) {
	out := new(GetAllPartys)
...
type PartyServiceServer interface {
	...
	GetByIdParty(context.Context, *election.ById) (*GetAllPartys, error)
...
func (UnimplementedPartyServiceServer) GetByIdParty(context.Context, *election.ById) (*GetAllPartys, error) {
