...
type ElectionServiceClient interface {
	...
	GetByIdElection(ctx context.Context, in *ById, opts ...grpc.CallOption) (*GetAllElection, error)
}
...
func (c *electionServiceClient) GetByIdElection(ctx context.Context, in *ById, opts ...grpc.CallOption) (*GetAllElection, error) {
...
type ElectionServiceServer interface {
	...
	GetByIdElection(context.Context, *ById) (*GetAllElection, error)
...
func (UnimplementedElectionServiceServer) GetByIdElection(context.Context, *ById) (*GetAllElection, error) {
