...
const (
	ElectionService_CreateElection_FullMethodName  = "/protos.ElectionService/CreateElection"
	ElectionService_DeleteElection_FullMethodName  = "/protos.ElectionService/DeleteElection"
	ElectionService_UpdateElection_FullMethodName  = "/protos.ElectionService/UpdateElection"
	ElectionService_GetByIdElection_FullMethodName = "/protos.ElectionService/GetByIdElection"
	ElectionService_GetAllElections_FullMethodName = "/protos.ElectionService/GetAllElections"
)
...
func (c *electionServiceClient) GetByIdElection(ctx context.Context, in *ById, opts ...grpc.CallOption) (*Election, error) {
	out := new(Election)
	err := c.cc.Invoke(ctx, ElectionService_GetByIdElection_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *electionServiceClient) GetAllElections(ctx context.Context, in *Void, opts ...grpc.CallOption) (*GetAllElection, error) {
	...
	err := c.cc.Invoke(ctx, ElectionService_GetAllElections_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
